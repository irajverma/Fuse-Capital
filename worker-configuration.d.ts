/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d5a50f0add187d0b9e4c9b281a1c3505)
// Runtime types generated with workerd@1.20260708.1 2026-06-18 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	RATE_LIMITER: RateLimit;
	RATE_LIMITER_APPLY: RateLimit;
	RATE_LIMITER_PARTNER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEV_BYPASS" | "turnstile_site_key" | "turnstile_secret_key">> {}
}
